...
// ----- STATS CALCULATION -----
	...
	// Reign of Midgard: L'Ordre de la Faille (Magic) faction bonus for the Mage branch (Mage/Wizard/High Wizard/Warlock/...).
	...
	// Reign of Midgard: Les Forgenoires (Technology) faction bonus for the Merchant branch (Merchant/Blacksmith/Whitesmith/Mechanic/...).
